	...
	public class VSSHARE: MonoBehaviour  
	{
		...
		public void OnClickedOnIconScreenshot()
		{
			...
			else
			{
				...
				{
					ShareScreenshot(commonAppSettings.ShareText, ShareType.Native);
				}
...
//			GetComponent<RectTransform>().localPosition = Vector2.zero;
		...
		{
			ShareScreenshot(commonAppSettings.ShareText, ShareType.Facebook);
		}

		public void OnClickedOnTwitter()
		{
			ShareScreenshot(commonAppSettings.ShareText, ShareType.Twitter);
		}

		public void OnClickedOnWhatsapp()
		{
			ShareScreenshot(commonAppSettings.ShareText, ShareType.Whatsapp);
		}
...
AndroidJNIHelper.debug = true;
		...
		{
			if(withText)
				self.OpenShareImageMobileNativeDialog ( commonAppSettings.ShareText );
			else
