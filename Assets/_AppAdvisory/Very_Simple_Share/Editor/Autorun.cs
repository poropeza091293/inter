...
//			SetSymbolsForTarget (BuildTargetGroup.XboxOne, VSRATE);
		...
		static void RunOnce() 
		{
			...
			int count = EditorPrefs.GetInt(WelcomeVerySimpleShare.PREFSHOWATSTARTUP + "autoshow",0);
			...
			EditorPrefs.SetInt(WelcomeVerySimpleShare.PREFSHOWATSTARTUP + "autoshow", count + 1);
